...
No. BCILattice remains a closed-source local research application. This repository documents public integration contracts only.
...
Use GitHub Discussions for integration planning and community questions. Use security@bcinexus.com for vulnerabilities.

## Can I contribute examples?

Yes, if they contain only public code, synthetic data, and no proprietary implementation.
